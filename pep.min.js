! function(t, e) {
  ...
  function n(t, e, n, i) {
    this.addCallback = t.bind(i), this.removeCallback = e.bind(i), this.changedCallback = n.bind(i), I && (this.observer = new I(this.mutationWatcher.bind(this)))
  }
    ...
    if (!window.PointerEvent) {
      if (window.PointerEvent = t, window.navigator.msPointerEnabled) {
        ...
        Object.defineProperty(window.navigator, "maxTouchPoints", {
          value: e,
          enumerable: !0
        }), y.registerSource("ms", Z)
      } else Object.defineProperty(window.navigator, "maxTouchPoints", {
        value: 0,
        enumerable: !0
      }), y.registerSource("mouse", x), void 0 !== window.ontouchstart && y.registerSource("touch", q);
      y.register(document)
    }
  }
  ...
  var p = ["bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "pageX", "pageY"],
    v = [!1, !1, null, null, 0, 0, 0, 0, !1, !1, !1, !1, 0, null, 0, 0],
  ...
  var m = ["bubbles", "cancelable", "view", "detail", "screenX", "screenY", "clientX", "clientY", "ctrlKey", "altKey", "shiftKey", "metaKey", "button", "relatedTarget", "buttons", "pointerId", "width", "height", "pressure", "tiltX", "tiltY", "pointerType", "hwTimestamp", "isPrimary", "type", "target", "currentTarget", "which", "pageX", "pageY", "timeStamp"],
    E = [!1, !1, null, null, 0, 0, 0, 0, !1, !1, !1, !1, 0, null, 0, 0, 0, 0, 0, 0, 0, "", 0, !1, "", null, null, 0, 0, 0, 0],
    b = {
      pointerover: 1,
      pointerout: 1,
      pointerenter: 1,
    ...
    y = {
      ...
      cloneEvent: function(t) {
        for (var e, n = Object.create(null), i = 0; i < m.length; i++) e = m[i], n[e] = t[e] || E[i], !T || "target" !== e && "relatedTarget" !== e || n[e] instanceof SVGElementInstance && (n[e] = n[e].correspondingUseElement);
      ...
      propagate: function(t, e, n) {
        for (var i = t.target, r = []; i !== document && !i.contains(t.relatedTarget);)
          if (r.push(i), i = i.parentNode, !i) return;
        n && r.reverse(), r.forEach(function(n) {
          t.target = n, e.call(this, t)
        }, this)
      },
      setCapture: function(e, n, i) {
  ...
  var g = {
    ...
    S = Array.prototype.slice.call.bind(Array.prototype.slice),
    O = Array.prototype.filter.call.bind(Array.prototype.filter),
  ...
  n.prototype = {
    watchSubtree: function(t) {
      this.observer && g.canTarget(t) && this.observer.observe(t, C)
    },
    ...
    findElements: function(t) {
      return t.querySelectorAll ? t.querySelectorAll(M) : []
    },
    ...
    flattenMutationTree: function(t) {
      ...
      return e.push(O(t, this.isElement)), e.reduce(this.concatLists, [])
    },
  ...
  var R = ["none", "auto", "pan-x", "pan-y", {
      rule: "pan-x pan-y",
      selectors: ["pan-x pan-y", "pan-y pan-x"]
    }],
    Y = "",
    N = window.PointerEvent || window.MSPointerEvent,
    _ = !window.ShadowDOMPolyfill && document.head.createShadowRoot,
    D = y.pointermap,
    L = 25,
    X = [1, 4, 2, 8, 16],
    k = !1;
  ...
  var F, x = {
      ...
      isEventSimulatedFromTouch: function(t) {
        for (var e, n = this.lastTouches, i = t.clientX, r = t.clientY, o = 0, a = n.length; a > o && (e = n[o]); o++) {
      ...
      mousedown: function(t) {
        if (!this.isEventSimulatedFromTouch(t)) {
          var e = D.get(this.POINTER_ID),
            n = this.prepareEvent(t);
          k || (n.buttons = X[n.button], e && (n.buttons |= e.buttons), t.buttons = n.buttons), D.set(this.POINTER_ID, t), e && 0 !== e.buttons ? y.move(n) : y.down(n)
        }
      },
      mousemove: function(t) {
        if (!this.isEventSimulatedFromTouch(t)) {
          var e = this.prepareEvent(t);
          k || this.prepareButtonsForMove(e, t), e.button = -1, D.set(this.POINTER_ID, t), y.move(e)
        }
      },
      mouseup: function(t) {
        if (!this.isEventSimulatedFromTouch(t)) {
          ...
          D.set(this.POINTER_ID, t), n.buttons &= ~X[n.button], 0 === n.buttons ? y.up(n) : y.move(n)
        }
      },
      mouseover: function(t) {
        if (!this.isEventSimulatedFromTouch(t)) {
          var e = this.prepareEvent(t);
          k || this.prepareButtonsForMove(e, t), e.button = -1, D.set(this.POINTER_ID, t), y.enterOver(e)
        }
      },
      mouseout: function(t) {
        if (!this.isEventSimulatedFromTouch(t)) {
          var e = this.prepareEvent(t);
          k || this.prepareButtonsForMove(e, t), e.button = -1, y.leaveOut(e)
        }
      },
      cancel: function(t) {
        var e = this.prepareEvent(t);
    ...
    K = y.captureInfo,
    j = g.findTarget.bind(g),
    B = g.allShadows.bind(g),
    U = y.pointermap,
    z = 2500,
    H = 200,
    G = "touch-action",
    q = {
      ...
      elementAdded: function(t) {
        ...
        n && (t._scrollType = n, y.listen(t, this.events), B(t).forEach(function(t) {
          t._scrollType = n, y.listen(t, this.events)
        }, this))
      },
      elementRemoved: function(t) {
        t._scrollType = void 0, y.unlisten(t, this.events), B(t).forEach(function(t) {
          t._scrollType = void 0, y.unlisten(t, this.events)
        }, this)
      },
      elementChanged: function(t, e) {
      ...
      moveOverOut: function(t) {
        ...
        if (n) {
          var i = n.out,
            r = n.outTarget;
          y.move(e), i && r !== e.target && (i.relatedTarget = e.target, e.relatedTarget = r, i.target = r, e.target ? (y.leaveOut(i), y.enterOver(e)) : (e.target = r, e.relatedTarget = null, this.cancelOut(e))), n.out = e, n.outTarget = e.target
        }
      },
      touchend: function(t) {
      ...
      upOut: function(t) {
        this.scrolling || (y.up(t), y.leaveOut(t)), this.cleanUpPointer(t)
      },
      touchcancel: function(t) {
        this.processTouches(t, this.cancelOut)
      },
      cancelOut: function(t) {
        y.cancel(t), y.leaveOut(t), this.cleanUpPointer(t)
      },
  ...
  var V, W, $, J = y.pointermap,
    ...
    Z = {
      ...
      prepareEvent: function(t) {
        var e = t;
        return Q && (e = y.cloneEvent(t), e.pointerType = this.POINTER_TYPES[t.pointerType]), e
      },
      cleanup: function(t) {
        J["delete"](t)
      },
      ...
      MSPointerUp: function(t) {
        var e = this.prepareEvent(t);
        y.up(e), this.cleanup(t.pointerId)
      },
      ...
      MSPointerCancel: function(t) {
        var e = this.prepareEvent(t);
        y.cancel(e), this.cleanup(t.pointerId)
      },
    ...
    tt = window.navigator;
  tt.msPointerEnabled ? (V = function(t) {
    u(t), c(this), l(t) && (y.setCapture(t, this, !0), this.msSetPointerCapture(t))
  }, W = function(t) {
    u(t), y.releaseCapture(t, !0), this.msReleasePointerCapture(t)
  }) : (V = function(t) {
    u(t), c(this), l(t) && y.setCapture(t, this)
  }, W = function(t) {
    u(t), y.releaseCapture(t)
  }), $ = function(t) {

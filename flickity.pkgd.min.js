...
function(t, e) {
  ...
  function o(e) {
    if (s(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
      ...
      for (var c = a.isBorderBox = "border-box" == o.boxSizing, d = 0; l > d; d++) {
        var u = h[d],
          f = o[u],
          p = parseFloat(f);
        a[u] = isNaN(p) ? 0 : p
...
function(t, e) {
  ...
  n.extend(p, e.prototype), p._create = function() {
    ...
    for (var n = this.cells.length, s = t; n > s; s++) {
      var o = this.cells[s];
  ...
  return p.setCellAlign = function() {
    ...
    !this.isDragSelect && o > r ? t += e : !this.isDragSelect && o > a && (t -= e), 0 > t ? this.x -= this.slideableWidth : t >= e && (this.x += this.slideableWidth)
    ...
    for (var s = 0; n && s < this.slides.length; s++) {
      var o = this.slides[s],
        r = o.cells.indexOf(n);
      if (-1 != r) return void this.select(s, e, i)
    }
    ...
    if (t) {
      var e = c(this.element, ":after").content; - 1 != e.indexOf("flickity") ? this.activate() : this.deactivate()
    }
...
function(t, e) {
  ...
  return s.insert = function(t, e) {
    ...
    for (e = 0; r > e; e++) n = s[e], n.remove(), i.removeFrom(this.cells, n);
